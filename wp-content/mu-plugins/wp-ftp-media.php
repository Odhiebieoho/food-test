...
function wpse_74180_upload_to_ftp($args)
{
    ...
    $settings = array(
        'host'      =>    'ftp.memanggo.blog',              // * the ftp-server hostname
        'port'    =>    21,                                 // * the ftp-server port (of type int)
        'user'      =>    'foodwp@memanggo.blog',                 // * ftp-user
        'pass'      =>    '14mgtar1.0mgnikotin',                     // * ftp-password
        'cdn'     =>    'food.memanggo.blog',            // * This have to be a pointed domain or subdomain to the root of the uploads
